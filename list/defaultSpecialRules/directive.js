myApp.directive('myListDefaultspecialrules', function() {
  return {
    restrict: 'E',
    transclude: true,
    scope: {
    ...
    controller: ['$scope', function($scope) {
      ...
      getGlobalVariable($scope,['unit','listsPos','getRulelName','specialRules','getModelName']);
    ...
    templateUrl: 'list/defaultSpecialRules/index.html'
  };
})